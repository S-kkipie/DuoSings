      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div className="">
            ...
            <p>
            In a world where communication is key, we are committed to 
            teaching and spreading sign language to facilitate interaction 
            and understanding between people with hearing disabilities and the world around them.
            </p>
          </div>
          <div>
